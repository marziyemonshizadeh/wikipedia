...
import { login ,useAuth } from "../fire/firebase";
         ...
         <form> 
           ...
           <div className="d-flex flex-column align-items-center mt-5">
            <label className="mb-3 w-50">
                    <span htmlFor="InputEmail" className="form-label">Email</span>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" fill="#EAECF0" className="bi bi-people-fill" viewBox="0 0 16 16">
