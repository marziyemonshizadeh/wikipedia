...
class Sidebar extends Component {
    state = { 
        ...
        listThree:["What links here",
              "Related changes",
              "Community porta",
              "Recent change",
              "Upload file"
            ],
        listFour:["Download as PDF",
              "Printable version"
            ],
        listFive:["Wikipedia Commons",
              "MediaWiki",
              "Meta-Wiki",
              ...
              <div className="ps-3">
                {
                    this.state.listOne.map((i, index)=>{
                      return (
                      <Links linkTxt={i.txt} key={index} disBlock="true" urls={i.url}/>  
                      )
                    })
                }
...

                {
                     this.state.listTwo.map((i, index)=>{
                        return <Links linkTxt={i} key={index} disBlock="true" urls="/"/>
                      })
                }
                  ...
                  <div className="d-flex justify-content-between border-bottom mt-2">
                    <div className='text-muted'>languages</div>
                        <svg 
                          ...
                          role='button' xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className='bi bi-gear-fill mt-1 sidebarSvg' viewBox="0 0 16 16">
