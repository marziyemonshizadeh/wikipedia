...
const SidebarMobile = (props) => {
  ...
  let listOne = [
    { name: "Home", svg: Svgs.home, url: "/wikipedia" },
        ...
        <div style={OVERLAY_STYLES}>
          <div className="position-relative" ref={ref}>
            <div
              ...
              style={{ width: 250, height: 1500 }}
            >
              {listOne.map((i, index) => {
                return (
                  <div
                    className="d-flex flex-row pt-2 ps-2 bg-white mb-1"
                    key={index}
                  >
                    {i.svg}
                    <div
                ...
                <>
                  {
                    ...
                    listTwo.map((i, index) => {
                      return (
                        <div
                          className="d-flex flex-row pt-2 ps-2 bg-white my-4"
                          key={index}
                        >
                          {i.svg}
                          <div
